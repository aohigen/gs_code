          ...
          <div class="animated fadeIn">
            ...
            <div class="card-body p-4" style="width:60%">
              ...
              <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" value="<?=$edit_user_info["status"]?>">
                
                <select id="filterDimension" name="status" class="pullDown">
                  <option value="<?=$edit_user_info["status"]?>">ステータスを変更する</option>
