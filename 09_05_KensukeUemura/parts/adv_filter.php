    ...
    <form action="index.php" method="get" style="text-align:right">
      ...
      <input type="number" name="val2" class="inputVal" style="width:80px; display:none">
        ...
        <div class="closeAdvFilter btn" style="font-size:90%;cursor: pointer;cursor: hand">閉じる</div>
        <div class="addFilter btn" style="font-size:90%;cursor: pointer;cursor: hand">＋条件を追加</div>
