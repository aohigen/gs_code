    ...
    <form action="index.php" method="get">
        ...
        <select id="filterDimension" name="dim" class="pullDown defaltFilter">
    ...
    <span class="advanceFilterBtn btn" style="font-size:80%;margin:5px;cursor: pointer;cursor: hand">アドバンスフィルタ</span>
