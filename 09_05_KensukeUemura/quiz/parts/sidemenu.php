<div class="sidebar">
    <nav class="sidebar-nav">
      <ul class="nav">
        ...
        <li class="nav-item nav-dropdown">
          <a class="nav-link nav-dropdown-toggle" href="all_report.php">
            <i class="nav-icon icon-cursor"></i> みんなの成績</a>
        </li>
        <li class="nav-title" style="color:gray">特典</li>
        <li class="nav-item nav-dropdown">
          <a class="nav-link nav-dropdown-toggle" href="special.php">
            <i class="nav-icon icon-puzzle"></i> ご褒美</a>
        </li>
