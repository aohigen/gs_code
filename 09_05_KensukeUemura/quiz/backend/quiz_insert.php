...
//NEWSに追加
$stmt = $pdo->prepare("INSERT INTO news(date,category,title,discription,user_id)VALUES(sysdate(),'クイズ作成',:title,:discription,:user_id)");
$stmt->bindValue(':title', $_POST["question"], PDO::PARAM_STR); 
$stmt->bindValue(':discription', '新しい問題「'.$_POST["question"].'」を追加しました！', PDO::PARAM_STR); 
