        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            ...
            <div class="card-body p-4" style="width:60%">
              <h1>10問チャレンジ</h1>
              <br>
              <p class="text-muted">「10問チャレンジ」は、サクッと１０問連続でOHORIクイズに挑戦するモードです。</p>
              <p class="text-muted">ぜひ、気軽にクイズに挑戦してください！</p>
              <div class="alert"></div>
              <a href="quiz.php" style="color:white"><button type="submit" class="btn btn-block btn-success">挑戦する</button></a>
            </div>
          </div>
                </div>
              </div>
